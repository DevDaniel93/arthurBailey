...
export const Menu = [
    ...
    { route: SCREENS.MyInvoices, labelKey: 'My Invoices', type: IconType.Foundation, icon: 'clipboard-notes', component: MyInvoices, },
    { route: SCREENS.Profile, labelKey: 'My Profile', type: IconType.AntDesign, icon: 'user', component: Profile, },
